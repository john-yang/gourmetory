...
<div class="row cover expanded align-middle text-center" style="background:url(http://placehold.it/1440x600);">
	<div class="column">
...
<table class="hover table-scroll" style="margin-top:5rem;">
  ...
  <tbody>
	...
	<div class="column large-12 large-centered" style="margin-top:5rem;">
		<div class="row align-middle">	
